// src/common/components/LoginPage.jsx
...
const ForgotPasswordView = ({ onBack }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setError('');
    try {
      const BASE_URL = import.meta.env.VITE_API_BASE_URL || 'http://localhost:8085/api/v1';
      ...
      <div className="view-forgot">
        <div className="success-screen">
          ...
          <p className="success-desc">
            If this email is registered, we've sent a secure password reset link.
            It expires in <strong style={{ color: '#c8a96e' }}>15 minutes</strong>.
          </p>
          <p className="success-email-hint">{email}</p>
          <div className="progress-track">
            <div className="progress-fill" />
          </div>
          <button className="submit-btn" onClick={onBack}>Back to Sign In</button>
  ...
  return (
    <div className="view-forgot">
      ...
      <div className="form-header">
        ...
        <p className="form-subtitle">Enter the email tied to your account.</p>
      </div>
...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // If backend requests a password reset
      if (data.passwordResetRequired) {
        navigate('/reset-password', { replace: true });
        return;
      }

      // Role-based redirect (handles ALL backend roles)
      const roles      = data.roles || [];
      const redirectTo = getDashboardRoute(roles);
    ...
    <div className="login-root">
      ...
      <div className="right-panel">
        <div className="panel-wrapper">
          ...
          {forgotView ? (
            <ForgotPasswordView onBack={() => setForgotView(false)} />
          ) : (
            <div className="view-login">
              ...
              <form onSubmit={handleLogin} noValidate>
                ...
                <button type="button" className="forgot-link" onClick={() => setForgotView(true)}>
                  Forgot password?
                </button>
