        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {students.map((student, index) => {
              ...
              const classInfo = student.classRoom
              ...
              return (
                ...
                >
                  ...
                  <td className="p-4 text-slate-600">{classInfo}</td>
                  ...
                  <td className="p-4">
                    {parent ? (
                      <>
                        <p className="font-medium text-slate-700">{parent.fullName}</p>
                        <p className="text-xs text-slate-400">{parent.relationType || "Parent"}</p>
                      </>
                    ) : (
                  ...
                  <td className="p-4">
                    {parent ? (
                      <>
                        <p className="text-sm text-slate-600">{parent.phoneNumber || "—"}</p>
