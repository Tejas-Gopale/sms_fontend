...
import { Plus, Trash2, Search, CreditCard, IndianRupee, X, Banknote, TrendingUp, AlertCircle, CheckCircle2, Settings2, ShieldCheck, ShieldAlert } from "lucide-react";
          ...
          <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden">
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                ...
                <button onClick={() => setPaymentAmount(String(selectedStudent.dueAmount))} className="mt-2 text-xs text-blue-600 hover:underline">Fill full due amount</button>
              </div>

              <div className="grid grid-cols-2 gap-3">
                <button onClick={() => handleProcessPayment("Cash")} disabled={loading} className="flex flex-col items-center gap-3 p-4 border-2 border-slate-200 hover:border-slate-300 rounded-xl transition disabled:opacity-50">
                  <Banknote size={20} className="text-slate-600" />
                  <span className="text-sm font-semibold text-slate-700">Cash Payment</span>
                </button>
                <button onClick={() => handleProcessPayment("Online")} disabled={loading} className="flex flex-col items-center gap-3 p-4 border-2 border-emerald-200 bg-emerald-50 hover:bg-emerald-100 rounded-xl transition disabled:opacity-50">
