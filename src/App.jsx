// src/App.jsx
// ✅ Complete role-based routing for ALL backend roles:
...
// ── Role groups for cleaner ProtectedRoute declarations ─────────────────────
const ADMIN_ROLES       = ["SCHOOL_ADMIN"];
const PRINCIPAL_ROLES   = ["PRINCIPAL", "VICE_PRINCIPAL"];
const TEACHER_ROLES     = ["TEACHER", "CLASS_TEACHER"];
const ALL_STAFF_ROLES   = [...ADMIN_ROLES, ...PRINCIPAL_ROLES, ...TEACHER_ROLES,
                           "COUNSELOR", "ACCOUNTANT", "CASHIER", "TRANSPORT_MANAGER",
                           "BUS_DRIVER", "BUS_CONDUCTOR", "LIBRARIAN", "RECEPTIONIST",
                           "NURSE", "SECURITY", "HOUSEKEEPING", "CANTEEN_STAFF", "IT_ADMIN"];
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* ── School Owner (read-only financial view) ────────────────────── */}
        ...
        <Route path="/principal/results"        element={<ProtectedRoute roles={PRINCIPAL_ROLES}><SchoolAdminDashboard /></ProtectedRoute>} />
