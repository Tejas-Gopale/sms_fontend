...
import GlobalToast              from "./common/utils/GlobalToast";
...
import CounselorReferrals      from "./counselor/pages/CounselorReferrals";
import CounselorSessions       from "./counselor/pages/CounselorSessions";
import NurseHealthRecords      from "./nurse/pages/NurseHealthRecords";
import NurseVisits             from "./nurse/pages/NurseVisits";
import HousekeepingTasks       from "./housekeeping/pages/HousekeepingTasks";
import HousekeepingManagement  from "./school_admin/pages/HousekeepingManagement";
import RaiseFacilityComplaint  from "./common/pages/RaiseFacilityComplaint";
import BusBoarding             from "./bus_driver/pages/BusBoarding";
import TransportBoardingOverview from "./transport_manager/pages/TransportBoardingOverview";
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/raise-complaint" element={<ProtectedRoute roles={ALL_BACKEND_ROLES}><RaiseFacilityComplaint /></ProtectedRoute>} />
        ...
        <Route path="/school-admin/housekeeping"     element={<ProtectedRoute roles={ADMIN_ROLES}><HousekeepingManagement /></ProtectedRoute>} />
        ...
        <Route path="/counselor/referrals"        element={<ProtectedRoute roles={["COUNSELOR"]}><CounselorReferrals /></ProtectedRoute>} />
        <Route path="/counselor/sessions"         element={<ProtectedRoute roles={["COUNSELOR"]}><CounselorSessions /></ProtectedRoute>} />
        ...
        <Route path="/transport-manager/boarding"         element={<ProtectedRoute roles={["TRANSPORT_MANAGER"]}><TransportBoardingOverview /></ProtectedRoute>} />
        ...
        <Route path="/bus-driver/boarding"          element={<ProtectedRoute roles={["BUS_DRIVER","BUS_CONDUCTOR"]}><BusBoarding /></ProtectedRoute>} />
        ...
        <Route path="/nurse/health-records"     element={<ProtectedRoute roles={["NURSE"]}><NurseHealthRecords /></ProtectedRoute>} />
        <Route path="/nurse/medical-stock"      element={<ProtectedRoute roles={["NURSE"]}><NurseDashboard /></ProtectedRoute>} />
        <Route path="/nurse/incidents"          element={<ProtectedRoute roles={["NURSE"]}><NurseVisits /></ProtectedRoute>} />
        ...
        <Route path="/staff/tasks"                 element={<ProtectedRoute roles={["HOUSEKEEPING"]}><HousekeepingTasks /></ProtectedRoute>} />
